...
function loadTimes(min, sec){
    ...
    countTimeChill = countTimeChill/3;
    countTimeChill = countTimeChill + 5;
    console.log(countTimeChill);
    min = Math.trunc((countTimeChill / 60));
    sec = Math.trunc((countTimeChill % 60));
